...
import { Cat, Skull, ShieldAlert } from 'lucide-react';
...
const MenuBtn: React.FC<{
  ...
  <button
    onClick={onClick}
    className={`group relative w-full md:w-80 h-24 bg-black/80 border border-dashed ${borderColor} hover:bg-green-900/10 transition-all duration-200 overflow-hidden flex items-center px-6 gap-5`}
  >
    ...
    <div className="flex flex-col items-start">
      <span className={`font-vt323 text-3xl tracking-widest ${textColor} drop-shadow-[0_0_5px_rgba(0,255,0,0.5)] group-hover:term-text-glow`}>
        {label}
      </span>
  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center bg-black z-30">
      ...
      <div className="mb-12 text-center relative px-4">
        ...
        <h1 className="relative font-vt323 text-6xl md:text-8xl text-green-500 drop-shadow-[0_0_10px_rgba(0,255,65,0.8)] mb-2 tracking-widest glitch-text cursor-default select-none">
          MASTER_OF_CATS
        </h1>
